...
status: Pipeline restored — daily blog automation + gpt-image-2 banner generation operational
...
- Today's post is generated but NOT published (`pipeline.py --publish` not run).
