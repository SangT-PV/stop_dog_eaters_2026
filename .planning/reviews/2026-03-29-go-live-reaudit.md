...
| H7 | HIGH | admin-utils.js loaded in production | **PASS** | Zero unconditional script tags. Conditional loader (only when ?admin=true in URL) on 4 pages — regular visitors never download it. |
